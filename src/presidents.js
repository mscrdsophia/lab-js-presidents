...
function  countYearsInOffice(presidentsArr) {
  return presidentsArr.reduce((totalYears, presidents) => {
    ...
    const yearsInOffice = presidents.leftOffice - presidents.tookOffice;
...
function getAgeAtInauguration(presidentsArr) {
  return presidentsArr.map(presidents => {
    const ageAtInauguration = presidents.tookOffice - presidents.birthYear;
    return { ...presidents,
...
function getPresidentsBornAfter(presidentsArr, year) {
  return presidentsArr.filter(presidents => presidents.birthYear > year)
}
...
function countRepublicanPresidents(presidentsArr) {
  return presidentsArr.reduce((count, presidents) => {
